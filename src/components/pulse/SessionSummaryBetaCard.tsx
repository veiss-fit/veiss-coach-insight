...
/**
 * Group 6b — Heart rate / calories. Other half of the old "Effort & readiness" card, split out
    ...
    <div className="v-card padded" style={{ display: "flex", flexDirection: "column", gap: 10, minWidth: 0 }}>
      <div className="row" style={{ justifyContent: "space-between", alignItems: "center", gap: 8, flexWrap: "wrap" }}>
        ...
        <span className="row" style={{ gap: 4 }}>
          <BetaBadge />
          <MetricInfoTip label="About session summary" text="Whole-session average heart rate and calories, from a wearable rather than the bar sensor." />
        </span>
      </div>
      <div className="row" style={{ gap: 20 }}>
        <div style={{ display: "flex", flexDirection: "column", gap: 2 }}>
          <span className="v-meta" style={{ fontSize: 10.5 }}>Avg heart rate</span>
          <span className="row" style={{ alignItems: "baseline", gap: 3 }}>
            <span className="num" style={{ fontSize: 20, fontWeight: 600, letterSpacing: "-0.02em", color: "var(--ink-0)" }}>
              {Math.round(stats.avgHeartRateBpm)}
            </span>
            <span className="v-mute2 mono" style={{ fontSize: 10.5 }}>bpm</span>
          </span>
        </div>
        <div style={{ display: "flex", flexDirection: "column", gap: 2 }}>
