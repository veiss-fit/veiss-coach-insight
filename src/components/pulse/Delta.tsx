...
export function Delta({ value, suffix = "", neutralThreshold = 0.005, invert = false }: DeltaProps) {
  ...
  return (
    <span className="row mono" style={{ color, gap: 3, fontSize: 11.5, fontWeight: 500 }}>
